function [data_var] = extract_varFC(index_long, index_lat,varname,filename)
%
% 
vardata= ncread(filename, varname,[20000 4000 1],[1000 1000 1]);
index_long = index_long - 20000;
index_lat = index_lat -4000;
